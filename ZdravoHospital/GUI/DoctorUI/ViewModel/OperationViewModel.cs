    ...
    public class OperationViewModel : ViewModel
    {
        ...
        public void Executed_ConfirmCommand()
        {
            ...
            try
            {
                ...
                MessageText = "Operation updated successfully.";
                IsEditModeOn = false;
            ...
            {
                MessageText = "Cannot edit operation which has already started or ended.";
            }
        ...
        public void Executed_CancelCommand()
        {
            ...
            {
                MessageText = "Can't cancel an operation which has already started.";
                MessagePopUpVisibility = Visibility.Visible;
                return;
            }
        ...
        public void Executed_YesCancelCommand()
        {
            ...
            MessageText = "Operation canceled successfully.";
            MessagePopUpVisibility = Visibility.Visible;
        }
